...
internal class EnglishPluralizationService : PluralizationService
{
    ...
    private string[] _uninflectiveSuffixList =  new []
    {
        "fish", "ois", "sheep", "deer", "pos", "itis", "ism"
    };

    private string [] _uninflectiveWordList =  new []
    {
        "bison",
        "flounder",
        "pliers",
    ...
    private Dictionary<string, string> _irregularVerbList = new()
    {
        {"am", "are"},
        {"are", "are"},
        {"is", "are"},
    ...
    private Dictionary<string, string> _irregularPluralsDictionary =  new()
    {
        {"brother", "brothers"},
        {"child", "children"},
        {"cow", "cows"},
    ...
    private Dictionary<string, string> _assimilatedClassicalInflectionDictionary =  new()
    {
    ...
    private Dictionary<string, string> _oSuffixDictionary = new()
    {
    ...
    private Dictionary<string, string> _classicalInflectionDictionary = new()
    {
    ...
    private Dictionary<string, string> _wordsEndingWithSeDictionary = new ()
    {
    ...
    private Dictionary<string, string> _wordsEndingWithSisDictionary =  new()
    {
    ...
    private Dictionary<string, string> _wordsEndingWithSusDictionary = new()
    {
        {"consensus","consensuses"},
        {"census", "censuses"}
    };

    private Dictionary<string, string> _wordsEndingWithInxAnxYnxDictionary =  new()
    {
        {"sphinx", "sphinxes"},
        {"larynx", "larynges"},
        {"lynx", "lynxes"},
    ...
    internal EnglishPluralizationService()
    {
        ...
        _irregularPluralsPluralizationService = new StringBidirectionalDictionary(this._irregularPluralsDictionary);
        _assimilatedClassicalInflectionPluralizationService = new StringBidirectionalDictionary(this._assimilatedClassicalInflectionDictionary);
        _oSuffixPluralizationService = new StringBidirectionalDictionary(this._oSuffixDictionary);
        _classicalInflectionPluralizationService = new StringBidirectionalDictionary(this._classicalInflectionDictionary);
        _wordsEndingWithSePluralizationService = new StringBidirectionalDictionary(this._wordsEndingWithSeDictionary);
        _wordsEndingWithSisPluralizationService = new StringBidirectionalDictionary(this._wordsEndingWithSisDictionary);
        _wordsEndingWithSusPluralizationService = new StringBidirectionalDictionary(this._wordsEndingWithSusDictionary);
        _wordsEndingWithInxAnxYnxPluralizationService = new StringBidirectionalDictionary(this._wordsEndingWithInxAnxYnxDictionary);
        _irregularVerbPluralizationService = new StringBidirectionalDictionary(this._irregularVerbList);
        _knownSingularWords = new List<string>(
    ...
    {
        if (_userDictionary.ExistsInSecond(word))  return true;
        if (_userDictionary.ExistsInFirst(word)) return false;
        if (IsUninflective(word) || _knownPluralWords.Contains(word.ToLower(Culture))) return true;
        else if (Singularize(word).Equals(word))  return false;
        else return true;
    }

    public override bool IsSingular(string word)
    {
        if (_userDictionary.ExistsInFirst(word)) return true;
        if (_userDictionary.ExistsInSecond(word)) return false;
        if (IsUninflective(word) || _knownSingularWords.Contains(word.ToLower(Culture))) return true;
        else if (!IsNoOpWord(word) && Singularize(word).Equals(word)) return true;
        else return false;
    }
    ...
    /// <summary>
    /// capitalize the return word if the parameter is capitalized
